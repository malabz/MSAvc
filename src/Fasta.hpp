...
namespace utils
{
    ...
    public:
        ...
        void write_to(std::stringstream &ss, bool output_name = true) const;

        static void write_with_wrapping(std::ostream &os, const std::string &sequence);
        static void write_with_wrapping(std::stringstream &os, const std::string &sequence);
        ...
        template<typename InputIterator>
        static void write_to(std::stringstream &os, InputIterator sequence_first, InputIterator sequence_last)
        {
            if (sequence_first == sequence_last) return;
        ...
        template<typename InputIterator1, typename InputIterator2>
        static void write_to(std::stringstream &os, InputIterator1 sequence_first, InputIterator1 sequence_last,
                InputIterator2 name_first)
        {
            if (sequence_first == sequence_last) return;
